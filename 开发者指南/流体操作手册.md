...
### 1.1 资产库配置
- 资产库链接：[https://simassets.orca3d.cn/]
- 资产中心 → 订阅以下资产：
  - `Kitchen_Fluid`
  - `tiangong2_pro_with_hands`

![Kitchen_Fluid 资产](../img/fluid/kitchen.png)
![tiangong2_pro_with_hands 资产](../img/fluid/tiangong2_pro_with_hands.png)
...
![OrcaGym dev 资产](../img/fluid/orcagym_dev.png)
![OrcaManipulation dev 资产](../img/fluid/OrcaManipulation_dev.png)
![OrcaPlayground dev 资产](../img/fluid/orcaplayground_dev.png)

### 1.4 安装依赖

在<仓库根>/OrcaManipulation下执行：
...
![Pico 安装包](../img/fluid/pico_install.png)
...
![OrcaLab 界面](../img/fluid/orcalab.png)

3. 进入 `Kitchen_Night_Fluid` 场景

![Kitchen_Night_Fluid 场景](../img/fluid/kitchen_night.png)
...
![VR 界面](../img/fluid/vr.png)

### 4.4 启动仿真

1. 在左侧大纲处，将机器人资产放到 `Group` 分组外，重命名为 `tiangong2`

![重命名机器人](../img/fluid/tiangong2.png)

2. 点击界面右上角 **绿色启动按钮**
3. 选择 **无仿真程序（手动启动）**

![启动仿真](../img/fluid/启动.png)
...
2. 进入数采脚本目录并启动：
   ```bash
   cd <仓库根>/OrcaManipulation/src/examples/dataCollection
