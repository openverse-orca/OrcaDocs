...
<td></td>
<td>取消测距&取消量脚</td>
<td>点击上方菜单栏鼠标模式切换到其它，测距和量脚标记会消失再次点击测距或量角按钮之前的测量标记会再显示；按键盘X会删除所有测距和量角的标记</td>
<td>X键 / 切换菜单栏模式</td>
</tr>
<tr class="even">
<td><img src="img/客户端基础操作指南/枢纽点按钮.png" style="width:0.26042in;height:0.23958in" /></td>
<td>枢纽点</td>
<td>选中多个物体后可切换枢纽点（Pivot）模式，系统据此计算变换控件（Gizmo）显示位置与变换参考中心，并控制多选物体的最终变换结果；默认中位点，支持各自中心、包围盒中心、中位点、激活的物体四种模式，移动/旋转/缩放围绕对应中心进行</td>
<td>--</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td><img src="img/客户端基础操作指南/递归显示按钮.png" style="width:0.26042in;height:0.23958in" /></td>
<td>递归显示</td>
<td>递归展示当前资产及其子级的关节、刚体、相机等全部信息；在左侧大纲栏选中资产后点击该按钮，右侧编辑栏将以列表形式展示所有信息，并支持筛选查看</td>
<td>--</td>
</tr>
<tr class="odd">
...
该模块主要有编辑功能，【编辑】主要负责资产Transform属性编辑（Position、Rotation、Uniform
Scale），碰撞体，刚体，相机等也可以进行编辑。

<img src="img/客户端基础操作指南/编辑.png" width="77%" >


1.【编辑】功能：在大纲列表或视图中选中资产，右侧【编辑栏】会显示该物品的Transform信息，包含Position、Rotation、Uniform
Scale，可点击直接输入数字进行精确修改，同时也可通过滑动在鼠标移至数据条时出现的箭头进行相关参数的调整。

<img src="img/客户端基础操作指南/大纲-视图-编辑.png" width="77%" >

2.结合【递归显示】功能，展示资产的所有信息，并且可以筛选编辑。下图以机器人相机为例，按照图中标的顺序依次点击可以进行筛选编辑。

<img src="img/客户端基础操作指南/编辑栏递归显示.png" width="77%" >
