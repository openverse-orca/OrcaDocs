...
- [How to run data collection scripts?](FAQ-list/093-how-to-run-data-collection-scripts.md)
...
- [What to do if ADB connection fails?](FAQ-list/092-what-to-do-if-adb-connection-fails.md)